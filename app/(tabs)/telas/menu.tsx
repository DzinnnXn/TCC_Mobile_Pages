...
interface ConfigProps {
  onNavigate: (screen: string) => void; // Adicionando a prop de navegação
}

export default function Menu({ onNavigate }: ConfigProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Botão de Sair */}
      <TouchableOpacity style={styles.logout_button} onPress={() => onNavigate('Home')}>
